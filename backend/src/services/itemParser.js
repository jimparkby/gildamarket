...
const VALID_CATEGORIES = ['shoes', 'coats', 'tshirts', 'midlayer', 'pants', 'bags', 'accessories', 'art', 'other'];
...
Категории: shoes=обувь, coats=верхняя одежда/куртки/пальто/шубы, tshirts=футболки/рубашки/блузы/топы, midlayer=свитера/джемперы/кардиганы/худи, pants=брюки/джинсы/шорты/юбки, bags=сумки/рюкзаки/клатчи, accessories=аксессуары/украшения/ремни/шарфы/шапки, art=искусство/живопись/скульптура/графика/принты/постеры, other=всё остальное
